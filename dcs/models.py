...
class Ad8Lidsensor(AbstractAdLidsensor):
    class Meta(AbstractAdLidsensor.Meta):
        db_table = u'AD8_LidSensor'
...
class LansEnvPth(DcsModel):
    lans_pth_p1 = models.DecimalField(decimal_places=2, null=True, max_digits=8, db_column='LANS_PTH_P1', blank=True) # Field name made lowercase.
    lans_pth_t1 = models.DecimalField(decimal_places=2, null=True, max_digits=8, db_column='LANS_PTH_T1', blank=True) # Field name made lowercase.
    lans_pth_h1 = models.DecimalField(decimal_places=2, null=True, max_digits=8, db_column='LANS_PTH_H1', blank=True) # Field name made lowercase.
    lans_pth_p2 = models.DecimalField(decimal_places=2, null=True, max_digits=8, db_column='LANS_PTH_P2', blank=True) # Field name made lowercase.
    lans_pth_t2 = models.DecimalField(decimal_places=2, null=True, max_digits=8, db_column='LANS_PTH_T2', blank=True) # Field name made lowercase.
    lans_pth_h2 = models.DecimalField(decimal_places=2, null=True, max_digits=8, db_column='LANS_PTH_H2', blank=True) # Field name made lowercase.
    class Meta(DcsModel.Meta):
