...
function load_formulas(){
    formulas = {
        Ad1Lidsensor : {
            ...
            capacitance_gdls: function(x) { return 0.1507*x+0.5525; }
            capacitance_ls:   function(x) { return 0.15015*x+14.2473; }
        },
        Ad2Lidsensor : {
            ...
            capacitance_gdls: function(x) { return 0.15105*x-1.8593; }
            capacitance_ls:   function(x) { return 0.15175*x+15.0732; }
        },
        Ad3Lidsensor : { // TODO: check GdLS, LS capacitance offsets
            ...
            capacitance_gdls: function(x) { return 0.1517*x-4.5397; }
            capacitance_ls:   function(x) { return 0.14785*x-4.2578; }
        },
        Ad4Lidsensor : { // TODO: check GdLS, LS capacitance offsets
            ...
            capacitance_gdls: function(x) { return 0.14815*x-7.6; }
            capacitance_ls:   function(x) { return 0.14830*x-3.77; }
        }
        Ad5Lidsensor : { // TODO: check GdLS, LS capacitance offsets
            ...
            capacitance_gdls: function(x) { return 0.1452*x+5.0587; }
            capacitance_ls:   function(x) { return 0.14790*x-0.3816; }
        },
        Ad6Lidsensor : { // TODO: check GdLS, LS capacitance offsets
            ...
            capacitance_gdls: function(x) { return 0.1471*x+0.0000; }
            capacitance_ls:   function(x) { return 0.15125*x+0.00; }
        },
