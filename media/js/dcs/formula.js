...
function load_formulas(){
    formulas = {
        Ad1Lidsensor : {
            ...
            temperature_gdls: function(x) { return x+0.256; },
            temperature_ls:   function(x) { return x+0.156; }
        },
        Ad2Lidsensor : {
            ...
            temperature_gdls: function(x) { return x-0.026; },
            temperature_ls:   function(x) { return x+0.13;  }
        },
        Ad3Lidsensor : { 
            ...
            temperature_gdls: function(x) { return x+0.07; },
            temperature_ls:   function(x) { return x+0.05; }
        },
        Ad4Lidsensor : {
            ...
            temperature_gdls: function(x) { return x+0.24;  },
            temperature_ls:   function(x) { return x+0.005; }
        },
        Ad5Lidsensor : {
            ...
            temperature_gdls: function(x) { return 0.996*x+0.356; },
            temperature_ls:   function(x) { return 0.992*x+0.451; }
        },
        Ad6Lidsensor : { // TODO: check GdLS, LS capacitance offsets
            ...
            temperature_gdls: function(x) { return 0.997*x+0.283; },
            temperature_ls:   function(x) { return 0.995*x-0.160; }
        },
        Ad7Lidsensor : { // placeholders only
            ...
            temperature_gdls: function(x) { return 0.992*x+0.391; }, // sensor V
            temperature_ls:   function(x) { return 0.995*x+0.355; }  // sensor v
        },
        Ad8Lidsensor : { // placeholders only
            ...
            capacitance_gdls: function(x) { return -0.1507*x+0.5525+41; },
            capacitance_ls:   function(x) { return -0.15015*x+14.2473+23; },
            temperature_gdls: function(x) { return 0.992*x+0.262; }, // sensor Y
            temperature_ls:   function(x) { return 0.996*x+0.220; }  // sensor y
        }
    };
}
